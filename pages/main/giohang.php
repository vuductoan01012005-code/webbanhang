...
?>
 ...
 $tongtien=0;
  ...
  <tr>
    ...
    <td>
        <a href="pages/main/themgiohang.php?cong=<?php echo $cart_item['id']?>"><i class="fa-solid fa-plus style"></i>  </a>
    <?php echo $cart_item['soluong'];?>
<a href="pages/main/themgiohang.php?tru=<?php echo $cart_item['id']?>"><i class="fa-solid fa-minus style"></i>  </a>
</td>
...
if(isset($_SESSION['dangky'])){
?>
<p><a href="pages/main/thanhtoan.php">Dặt hàng</a></p>
<?php
}else{
  ?>
